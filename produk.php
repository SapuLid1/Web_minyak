...
<head>
    ...
    <style>
        .banner-image {
            background-image: url("foto/Tcoconut_oil5.jpg");
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 menu1">
                ...
                <li class="nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu drop" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item drop" href="mengapa_kami.php">Mengapa Kami</a></li>
                        <li><a class="dropdown-item drop" href="portfolio.php">Portfolio</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="wrapper">
            <nav>
                <div class="items">
                    ...
                    <button type="button" class="item button1" data-name="dualiter">Dua liter</button>
                    <button type="button" class="item button1" data-name="tigaliter">Tiga liter</button>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 geser">
                        <div class="font-footer">
                            ...
                            <ul class="social-footer2">
                                ...
                                <li class=""><a href="tel:(0361)4747770" title="phone" target="_blank"><img alt="phone" width="30" height="30" src="logo/Icon Telepon.png"> </a></li>
